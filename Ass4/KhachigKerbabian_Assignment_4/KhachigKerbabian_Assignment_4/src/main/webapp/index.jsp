...
<main class="form-signin w-100 m-auto">
    <form action="<%= request.getContextPath()%>/AccountServlet" method="post">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="typeInteraction" id="Deposit" value="Deposit" checked>
            <label class="form-check-label" for="Deposit">
                Deposit
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="typeInteraction" id="Withdraw" value="Withdraw">
        ...
        <div class="input-group mb-3">
            <label class="form-check-label" for="amount">Enter Amount: </label>
        ...
        <div class="checkbox mb-3">
            ...
            <label>
                <p class="mt-5 mb-3 text-muted">The Balance is: ${bal}</p>
            </label>
        </div>
